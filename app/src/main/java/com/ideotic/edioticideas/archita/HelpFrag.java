...
public class HelpFrag extends DialogFragment implements TextToSpeech.OnInitListener {
    ...
    String main = "say EMAIL to go to mail module " +
            "\n say PHONE to go to phone module " +
            "\n say LOCATION to know your current location" +
            "\n say  PLAY MUSIC to hear a song " + " say NOTE to make a note " +
            "\n say DATE or TIME to know current date and time " +
            "2\n say WEATHER to know current weather";
    /*String main = "say EMAIL to go to mail module \n say PHONE to go to phone module \n say LOCATION to know your current location" +
    ...
    String gmail = "To read mails say GET EMAILS " +
            "\n To send a mail say COMPOSE EMAIL " +
            "\n To search mail say SEARCH SUBJECT your subject \n ";

    /*String gmail = "To read mails say GET EMAILS \n To send a mail say COMPOSE EMAIL \n To search mail say SEARCH SUBJECT your subject \n " +
            "To open a specific category say GET EMAILS category";*/
