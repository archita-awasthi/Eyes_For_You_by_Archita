...
public class Commands {
    ...
    public static final String mailModule = "email";
    ...
    public static final String MAIL_FETCH_MAILS = "get emails";
    ...
    public static final String MAIL_COMPOSE_MAIL = "compose email";
